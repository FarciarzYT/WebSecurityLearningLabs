...
export function LearningBox() {
    return (
        <>
            <section className={"grid grid-rows mx-auto mt-64 mb-8"}>
                <div className="w-full sm:w-[60%] mx-auto  gap-8 ">
                    <header
                        className={" p-8 rounded-3xl flex flex-col xl:flex-row gap-x-6 items-center"}>
                        <Image
                        ...
                        {articleItems.map((item) => {
                            return (
                                <article key={item.title}
                                         className={"bg-white/2 backdrop-blur-md p-8 rounded-3xl border-white/10"}>
                                    ...
                                    <button
                                        className={"bg-white items-center text-black sm:text-lg text-sm   px-3 py-2 rounded-3xl font-bold hover:bg-white/85 cursor-pointer transition duration-300 hover:translate-x-0.5 hover:-translate-y-1 flex gap-2"}>
                                        {item.btnIcon}
                                        {item.btnText}
                                    </button>
                                </article>
