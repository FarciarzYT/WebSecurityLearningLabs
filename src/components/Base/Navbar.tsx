...
export function Navbar() {
    ...
    return (
        <nav className="fixed sm:top-2 left-1/2 -translate-x-1/2 z-50 bg-white/2 backdrop-blur-lg shadow-2xl rounded-full">
            <div className="max-w-5xl  px-8 h-16 flex items-center justify-between">
                ...
                <div className="flex items-center gap-4 ">
                    {!isLoggedIn && (
                        <button
                            className="hidden xl:flex font-bold ml-8 text-[0.8rem] tracking-[0.12em] shadow-2xl uppercase cursor-pointer text-black bg-white hover:bg-white/85 focus:bg-white px-5 py-2 rounded-full hover:transition-all duration-200 hover:-translate-y-px"
                        >
                            Sign up
                        </button>
                    )}
