export function HeaderBox(){
    return (
        <>
            <div className="flex flex-col bg-white text-black w-[80%] shadow-2xl rounded-4xl mx-auto p-8 mb-8">
                <h2 className="font-bold text-[3rem]">Learn how web applications really break</h2>
