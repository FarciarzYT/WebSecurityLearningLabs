export function ListBox(){
    return (
        <>
            <div className="flex flex-col text-white border bg-black/2 border-white/10 w-[30%]  shadow-2xl rounded-4xl p-8 mb-8 transition-transform duration-300 cursor-pointer">
