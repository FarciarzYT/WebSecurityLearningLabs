export function ListBox(){
    return (
        <>
            <div className="flex flex-col bg-white text-black w-[30%]  shadow-2xl rounded-4xl p-8 mb-8 transition-transform duration-300 hover:scale-105 hover:shadow-3xl cursor-pointer">
